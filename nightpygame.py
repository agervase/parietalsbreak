...
############# possible day to night transition scene 30 ###############
    ...
    while scene36 and not done:
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawScene("pictures/Silvia - GTFO.png", "pictures/none.png", "pictures/forest_bg.png")
                drawPrompt("You're so distracted listenng for the person in the e-lounge that you don't even notice your rectore coming up behind you!")
    ...
    while scene39 and not done:
        for event in pygame.event.get():
			...
			if friendship > 0:
                ...
                drawScene("pictures/Silvia - GTFO.png", "pictures/none.png", "pictures/forest_bg.png")
                drawPrompt("You hear someone someone coming, and with your incredible hearing, you immediately determine that it's one og your dorm's ARs. What do you do?")
    ...
    while winscreen and not done:
		...
		if answer == 2:
			...
			scene59 = False
                ...
                drawScene("pictures/Silvia - GTFO.png", "pictures/none.png", "pictures/forest_bg.png")
                drawPrompt("This game was brought to you by PE Room 616 (#squadhouse). We'd like to thank everyone, including the h8rs, for inspiring us every day. Silvia would also like everyone to know that she hates all the orphans in the whole world.")
