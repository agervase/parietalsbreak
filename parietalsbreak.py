...
while not done:
    ...
    while scene6 and not done:
        for event in pygame.event.get():
			...
			scene6 = False
                ...
                drawScene("pictures/Silvia - neutral.png", "pictures/Sam - Sad.png", "pictures/hallway_bg.png")
    ...
    while scene6a and not done:
	    ...
	    numchoices = 1
			...
			scene7 = True
                ...
                drawScene("pictures/Silvia - neutral.png", "pictures/Sam - Smiling.png", "pictures/hallway_bg.png")
    ...
    while scene6b and not done:
	    ...
	    numchoices = 1
			...
			scene7 = True
                ...
                drawScene("pictures/Silvia - sigh.png", "pictures/Sam - Suspicious.png", "pictures/hallway_bg.png")
    ...
    while scene12 and not done:
		...
		if answer == 1 or answer == 4:
			...
			scene12 = False
                ...
                drawScene("pictures/Silvia - Smiling.png", "pictures/Grace - Smiling.png", "pictures/pasq_bg.png")
	...
	numchoices = 2
		...
		if answer == 1:
			...
			scene15 = False
                ...
                drawScene("pictures/Silvia - Smiling.png", "pictures/none.png", "pictures/dorm_bg.png")
    ...
    while scene16 and not done:
		...
		if answer == 1:
			...
			scene16 = False
                ...
                drawScene("pictures/Silvia - Smiling.png", "pictures/Roann - Smiling.png", "pictures/pasq_bg.png")
    ...
    while scene17 and not done:
		...
		if answer > 0:
			...
			scene17 = False
                ...
                drawScene("pictures/Silvia - Smiling.png", "pictures/Roann - Smiling.png", "pictures/dorm_bg.png")
    ...
    while scene18 and not done:
		...
		if answer > 0:
			...
			scene18 = False
                ...
                drawScene("pictures/Silvia - GTFO.png", "pictures/Roann - Awe.png", "pictures/forest_bg.png")
    ...
    while scene20 and not done:
	    ...
	    numchoices = 2
            if event.type == pygame.QUIT:
                ...
                drawScene("pictures/Silvia - thinking.png", "pictures/Abby - Smiling.png", "pictures/dorm_bg.png")
    ...
    while scene22 and not done:
        for event in pygame.event.get():
			...
			numCheese = numCheese+1
                ...
                drawScene("pictures/Silvia - thinking.png", "pictures/none.png", "pictures/hallway_bg.png")
    ...
    while scene24 and not done:
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawScene("pictures/Silvia - Nacho.png", "pictures/none.png", "pictures/hallway_bg.png")
    ...
    while scene26 and not done:
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawScene("pictures/Silvia - thinking.png", "pictures/Abby - Worried.png", "pictures/dorm_bg.png")
    ...
    while scene27 and not done:
	    ...
	    numchoices = 1
            if event.type == pygame.QUIT:
                ...
                drawScene("pictures/Silvia - sigh.png", "pictures/David - Sad.png", "pictures/dorm_bg.png")
    ...
    while scene27a and not done:
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawScene("pictures/Silvia - Sad.png", "pictures/David - Sad.png", "pictures/dorm_bg.png")
    ...
    while scene28 and not done:
		...
		if answer == 1:
			...
			scene28 = False
                ...
                drawScene("pictures/Silvia - sigh.png", "pictures/boys.png", "pictures/dorm_bg.png")
    ...
    while scene28a and not done:
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawScene("pictures/Silvia - GTFO.png", "pictures/David - Sad.png", "pictures/dorm_bg.png")
...
############# possible day to night transition scene 30 ###############
    ...
    while scene31 and not done:
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                drawChoices(numchoices, "Silvia", "Main staircase", " ", "Side staircase", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene26 = True

    while scene32 and not done:
        for event in pygame.event.get():
            numchoices = 2
            if event.type == pygame.QUIT:
                done = True
                ...
                drawChoices(numchoices, "Silvia", "Make a break for the staircase", " ", "Wait it out.", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene26 = True

    while scene33 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
			...
			scene33 = False
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "Dun dun DUUUUUUUN", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene34 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "Frick yeah, this is easy.", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene35 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawScene("pictures/Silvia - Game Over.png", "pictures/none.png", "pictures/forest_bg.png")
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "RIP", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True
	
    while scene36 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "Frick", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene37 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "Sweeeeeeet", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene38 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
    ...
    while scene39 and not done:
        for event in pygame.event.get():
			...
			if friendship > 0:
                ...
                drawChoices(numchoices, "Silvia", "Make a break for the staircase", " ", "Ask a friend to hide you.", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene26 = True

    while scene40 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "Ah, the magic of friendship.", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene41 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "*insert you tried star*", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene42 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "... Not that?", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene42a and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "I done messed up", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True
	
    while scene43 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "Wow Abby you should get on that.", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene53 and not done:
        for event in pygame.event.get():
            numchoices = 2
            if event.type == pygame.QUIT:
                done = True
                ...
                drawChoices(numchoices, "Silvia", "North staircase", " ", "West staircase", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene26 = True

    while scene54 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
			...
			if numCheese >= 3:
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "Why does the universe hate me?", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene55 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
			...
			scene55 = False
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "ALL HAIL THE CHEESE", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene56 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
			...
			scene56 = False
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "Wow, I've learned a valuable lesson about random acts of kindness.", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene57 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "Darn societal expectations.", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while scene58 and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
		...
		answer = getChoice(numchoices, m, n)
			...
			scene58 = False
                ...
                drawChoices(numchoices, "Silvia", " ", " ", "My life is basically Shawshank Redemption.", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True

    while winscreen and not done:
        for event in pygame.event.get():
	    numchoices = 1
            if event.type == pygame.QUIT:
                done = True
    ...
    while scene59 and not done:
		...
		if answer == 2:
			...
			scene59 = False
                ...
                drawChoices(numchoices, "Silvia", "This game was amazing and I want to play again!", " ", "This was the worst experience of my whole life", " ");
                pygame.display.update()
                pygame.display.flip()
                #scene25 = True
